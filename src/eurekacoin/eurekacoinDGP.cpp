...
void EurekacoinDGP::initDataSchedule(){
    dataSchedule = scheduleDataForBlockNumber(0);
}

bool EurekacoinDGP::checkLimitSchedule(const std::vector<uint32_t>& defaultData, const std::vector<uint32_t>& checkData, int blockHeight){
...
dev::eth::EVMSchedule EurekacoinDGP::getGasSchedule(int blockHeight){
    clear();
...
dev::eth::EVMSchedule EurekacoinDGP::createEVMSchedule(const dev::eth::EVMSchedule &_schedule, int blockHeight){
