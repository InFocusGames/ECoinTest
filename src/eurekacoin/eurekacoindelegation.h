#ifndef EUREKACOINDELEGATION_H
#define EUREKACOINDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The IEurekacoinStaker class Delegation filter
 */
...
/**
 * @brief The EurekacoinDelegation class Communicate with the eurekacoin delegation contract
 */
class EurekacoinDelegation {
    
public:
    /**
     * @brief EurekacoinDelegation Constructor
     */
    EurekacoinDelegation();

    /**
     * @brief ~EurekacoinDelegation Destructor
     */
    virtual ~EurekacoinDelegation();
...
private:
    EurekacoinDelegation(const EurekacoinDelegation&);
    EurekacoinDelegation& operator=(const EurekacoinDelegation&);
    EurekacoinDelegationPriv* priv;
};
#endif
