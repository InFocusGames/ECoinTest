...
class EurekacoinTransactionReceipt: public dev::eth::TransactionReceipt {
public:
    EurekacoinTransactionReceipt(dev::h256 const& state_root, dev::h256 const& utxo_root, dev::u256 const& gas_used, dev::eth::LogEntries const& log) : dev::eth::TransactionReceipt(state_root, gas_used, log), m_utxoRoot(utxo_root) {}
...
struct ResultExecute{
    ...
    EurekacoinTransactionReceipt txRec;
    CTransaction tx;
};
