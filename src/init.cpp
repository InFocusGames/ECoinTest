 ...
 */
static const char* BITCOIN_PID_FILENAME = "eurekacoind.pid";
...
void Shutdown(NodeContext& node)
{
    ...
    util::ThreadRename("eurekacoin-shutoff");
...
void DeleteBlockChainData()
{
    ...
    fs::remove_all(GetDataDir() / "stateEurekacoin");
    ...
    while (!fLoaded && !ShutdownRequested()) {
        ...
        do {
            ...
            try {
                ...
                globalSealEngine->setEurekacoinSchedule(eurekacoinDGP.getGasSchedule(::ChainActive().Height() + (::ChainActive().Height()+1 >= chainparams.GetConsensus().QIP7Height ? 0 : 1) ));
