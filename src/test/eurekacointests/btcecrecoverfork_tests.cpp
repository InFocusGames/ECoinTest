...
//    initState();
    ...
    std::vector<EurekacoinTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createEurekacoinTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createEurekacoinTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createEurekacoinTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createEurekacoinTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
