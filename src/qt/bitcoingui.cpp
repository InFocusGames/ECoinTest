...
void BitcoinGUI::createActions()
{
    ...
    openAction->setStatusTip(tr("Open a eurekacoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Eurekacoin command-line options").arg(PACKAGE_NAME));
