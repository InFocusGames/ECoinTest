...
<context>
    ...
    <message>
        <source>These are your Eurekacoin addresses for receiving payments. Use the 'Create new receiving address' button in the receive tab to create new addresses.</source>
        <translation>Αυτές είναι οι Eurekacoin διευθύνσεις για την λήψη πληρωμών. Χρησιμοποιήσε το κουμπί  'Δημιουργία νέας διεύθυνσης λήψεων' στο παράθυρο λήψεων για την δημιουργία νέας διεύθυνσης  </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <source>Remember that encrypting your wallet cannot fully protect your eurekacoins from being stolen by malware infecting your computer.</source>
        <translation>Θυμίσου ότι το να κρυπτογραφείς το πορτοφόλι σου δεν μπορεί να προστατέψει πλήρως τα eurekacoins σου από κλοπή από  κακόβουλο λογισμικό που έχει μολύνει τον υπολογιστή σου</translation>
    </message>
    <message>
...
<context>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n ενεργές συνδέσεις στο δίκτυο Eurekacoin</numerusform><numerusform>%n ενεργές συνδέσεις στο δίκτυο Eurekacoin</numerusform></translation>
    </message>
    <message>
    ...
    <message>
        <source>Open a eurekacoin: URI</source>
        <translation>Ανοίξτε ένα eurekacoin: URI</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Εμφάνισε το %1 βοηθητικό μήνυμα για λήψη μιας λίστας με διαθέσιμες επιλογές για Eurekacoin εντολές </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Εμφανίστηκε ένα μοιραίο σφάλμα. Το Eurekacoin δεν μπορεί πλέον να συνεχίσει με ασφάλεια και θα σταματήσει.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Η διεύθυνση "%1" δεν είναι έγκυρη Eurekacoin διεύθυνση.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Το %1 θα κατεβάσει και θα αποθηκεύσει ένα αντίγραφο της αλυσίδας μπλοκ Eurekacoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Οι πρόσφατες συναλλαγές ενδέχεται να μην είναι ακόμα ορατές και επομένως η ισορροπία του πορτοφολιού σας μπορεί να είναι εσφαλμένη. Αυτές οι πληροφορίες θα είναι σωστές όταν ολοκληρωθεί το συγχρονισμό του πορτοφολιού σας με το δίκτυο Eurekacoin, όπως περιγράφεται παρακάτω.</translation>
    </message>
    <message>
        ...
        <translation>Η προσπάθεια να δαπανήσετε eurekacoins που επηρεάζονται από τις μη εμφανιζόμενες ακόμη συναλλαγές δεν θα γίνει αποδεκτή από το δίκτυο.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <source>Open eurekacoin URI</source>
        <translation>Ανοίξτε το eurekacoin URI</translation>
    </message>
    <message>
        <source>URI:</source>
...
<context>
    ...
    <message>
        ...
        <translation>Συνδεθείτε στο δίκτυο Eurekacoin μέσω ενός ξεχωριστού διακομιστή μεσολάβησης SOCKS5 για κρυφές υπηρεσίες Tor.</translation>
    </message>
    <message>
        <source>&amp;Window</source>
        <translation>&amp;Παράθυρο</translation>
...
<context>
    ...
    <message>
        ...
        <translation>'eurekacoin: //' δεν είναι έγκυρο URI. Χρησιμοποιήστε το "eurekacoin:" αντ 'αυτού.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Δεν είναι δυνατή η ανάλυση του URI! Αυτό μπορεί να προκληθεί από μη έγκυρη διεύθυνση Eurekacoin ή παραμορφωμένες παραμέτρους URI.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Ένα προαιρετικό μήνυμα που επισυνάπτεται στο αίτημα πληρωμής, το οποίο θα εμφανιστεί όταν το αίτημα ανοίξει. Σημείωση: Το μήνυμα δεν θα αποσταλεί με την πληρωμή μέσω του δικτύου Eurekacoin.</translation>
    </message>
    <message>
...
Σημείωση: Δεδομένου ότι η χρέωση υπολογίζεται ανά βάση, η αμοιβή "100 satoshis ανά kB" για ένα μέγεθος συναλλαγής 500 bytes (το μισό του 1 kB) θα αποφέρει τέλος μόνο 50 satoshis.</translation>
    ...
    <message>
        ...
        <translation>Όταν υπάρχει λιγότερος όγκος συναλλαγών από το χώρο στα μπλοκ, οι ανθρακωρύχοι καθώς και οι κόμβοι αναμετάδοσης μπορούν να επιβάλουν ένα ελάχιστο τέλος. Η πληρωμή μόνο αυτού του ελάχιστου τέλους είναι μια χαρά, αλλά γνωρίζετε ότι αυτό μπορεί να οδηγήσει σε μια συναλλαγή που δεν επιβεβαιώνει ποτέ τη στιγμή που υπάρχει μεγαλύτερη ζήτηση για συναλλαγές eurekacoin από ό, τι μπορεί να επεξεργαστεί το δίκτυο.</translation>
    </message>
    <message>
    ...
    <message>
        <source>Please, review your transaction proposal. This will produce a Partially Signed Eurekacoin Transaction (PSBT) which you can copy and then sign with e.g. an offline %1 wallet, or a PSBT-compatible hardware wallet.</source>
        <translation>Παρακαλώ ελέγξτε την πρόταση συναλλαγής. Αυτό θα παράγει μια συναλλαγή Eurekacoin με μερική υπογραφή (PSBT), την οποία μπορείτε να αντιγράψετε και στη συνέχεια να υπογράψετε με π.χ. ένα πορτοφόλι %1 εκτός σύνδεσης ή ένα πορτοφόλι υλικού συμβατό με το PSBT.</translation>
    </message>
    <message>
        <source>or</source>
...
Δεν σηματοδοτεί την Aντικατάσταση-Aπό-Έξοδο, BIP-125.</translation>
    ...
    <message>
        ...
        <translation>Προειδοποίηση: Μη έγκυρη διεύθυνση Eurekacoin</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Το τέλος θα αφαιρεθεί από το ποσό που αποστέλλεται. Ο παραλήπτης θα λάβει λιγότερα eurekacoins από ό,τι εισάγετε στο πεδίο ποσό. Εάν επιλεγούν πολλοί παραλήπτες, το έξοδο διαιρείται εξίσου.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ένα μήνυμα που επισυνάφθηκε στο eurekacoin: URI το οποίο θα αποθηκευτεί με τη συναλλαγή για αναφορά. Σημείωση: Αυτό το μήνυμα δεν θα σταλεί μέσω του δικτύου Eurekacoin.</translation>
    </message>
    <message>
        <source>Pay To:</source>
        <translation>Πληρωμή σε:</translation>
