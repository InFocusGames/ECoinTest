    ...
    m_results(1)
{
    ...
    ui->labelSenderAddress->setToolTip(tr("The eurekacoin address that will be used to create the contract."));
...
void CreateContract::setModel(WalletModel *_model)
{
    ...
    // update the display unit, to not use the default ("EUREKACOIN")
    updateDisplayUnit();
}
